...
class WaybackCollection(ActionCollection):
    ...
    def __init__(self, arguments: ActionArguments) -> None:
        ...
        # Configuration
        self.user_agent = "AWorld-Runtime/1.0 (https://github.com/qingw-dev/AWorld-Runtime; qintong.wqt@antgroup.com)"
    ...
    async def mcp_get_wayback_capabilities(self) -> ActionResponse:
...
if __name__ == "__main__":
    ...
    try:
        service = WaybackCollection(arguments)
        service.run()
    except Exception as e:
